...
type MoneyItem = {
  ...
  currency_cn: string; //货币中文名称
  currency_en: string; //货币英文名称
  symbol?: string; //货币符号
  symbol_native?: string; //货币原生符号
};

export const supportCurrencys: string[] = [
  'AED',
  'AFN',
  'ALL',
  'AMD',
...
export const moneysCountryArr: MoneyItem[] = [
  {
    code: 'CN',
    en: 'China',
    cn: '中国',
...
export const moneysCurrencyArr: MoneyItem[] = [
  {
    code: 'CN',
    en: 'China',
    cn: '中国',
